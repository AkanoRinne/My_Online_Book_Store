...
<body>
	<div class="project_logo">
		<a href="index.php"><img src="product_logo.png" alt="My Online Book Store" width="120" height="120"/></a>
	</div>
	
	<!-- Navigation Bar for book category -->
	<div id="Nav">
	<form action="Nav_product.php" id="nav_product" method="POST">
		<div class="dropdown">
	...
	<!-- Display the product detail from database after the search button is clicked and the input is set -->
	<?php 
		...
		{
			 echo "<div class='none_result'>0 result</div>";
		}
		echo "</table></div></div>";
	?>
</body>
