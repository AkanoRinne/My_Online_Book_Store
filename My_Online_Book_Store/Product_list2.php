...
<body>
	...
	<div class="table-box">
		<div class="container">
			<div class="row">
				...
				<form action='Product_detail2.php' id="product_detail" method="POST"> 
	...
	if ($result-> num_rows >0) {
		while ($row = $result-> fetch_assoc()) {
			...
			"<input type='text' class='box sub_box col-sm-8 col-md-9' name='bookname1' value='".$ar2[0]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box sub_box col-sm-8 col-md-9' name='bookname2' value='".$ar2[1]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box sub_box col-sm-8 col-md-9' name='bookname3' value='".$ar2[2]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box sub_box col-sm-8 col-md-9' name='bookname4' value='".$ar2[3]."' readonly='readonly'></input>".
	...
	<div class="table-box2">
		<div class="container">
			<div class="row">
				<table class="table-bordered">
				<form action='Product_detail2.php' id="product_detail2" method="POST"> 
	<?php
	...
	if ($result-> num_rows >0) {
		while ($row = $result-> fetch_assoc()) {
			...
			"<input type='text' class='box2 sub_box2 col-sm-8 col-md-9' name='bookname5' value='".$ar2[0]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box2 sub_box2 col-sm-8 col-md-9' name='bookname6' value='".$ar2[1]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box2 sub_box2 col-sm-8 col-md-9' name='bookname7' value='".$ar2[2]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box2 sub_box2 col-sm-8 col-md-9' name='bookname8' value='".$ar2[3]."' readonly='readonly'></input>".
	...
	<div class="table-box3">
		<div class="container">
			<div class="row">
				<table class="table-bordered">
				<form action='Product_detail2.php' id="product_detail3" method="POST"> 
	<?php
	...
	if ($result-> num_rows >0) {
		while ($row = $result-> fetch_assoc()) {
			...
			"<input type='text' class='box3 sub_box3 col-sm-8 col-md-9' name='bookname9' value='".$ar2[0]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box3 sub_box3 col-sm-8 col-md-9' name='bookname10' value='".$ar2[1]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box3 sub_box3 col-sm-8 col-md-9' name='bookname11' value='".$ar2[2]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box3 sub_box3 col-sm-8 col-md-9' name='bookname12' value='".$ar2[3]."' readonly='readonly'></input>".
	...
	<div class="table-box4">
		<div class="container">
			<div class="row">
				<table class="table-bordered">
				<form action='Product_detail2.php' id="product_detail4" method="POST"> 
	<?php
	...
	if ($result-> num_rows >0) {
		while ($row = $result-> fetch_assoc()) {
			...
			"<input type='text' class='box4 sub_box4 col-sm-8 col-md-9' name='bookname13' value='".$ar2[0]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box4 sub_box4 col-sm-8 col-md-9' name='bookname14' value='".$ar2[1]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box4 sub_box4 col-sm-8 col-md-9' name='bookname15' value='".$ar2[2]."' readonly='readonly'></input>".
			...
			"<input type='text' class='box4 sub_box4 col-sm-8 col-md-9' name='bookname16' value='".$ar2[3]."' readonly='readonly'></input>".
